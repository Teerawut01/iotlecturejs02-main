...
// กรณีที่หน้า ? จะได้ค่าเป็น true จะได้ค่าหลังเครื่องหมาย :
// กรณีที่หน้า ? จะได้ค่าเป็น false จะได้ค่านั้นๆ เลย
...
let ii={data1:"Hello",data2:'Bay',data3:'Wow'}
let jj={data1:"Hello",data2:'Bay',data3:'Wow'}
